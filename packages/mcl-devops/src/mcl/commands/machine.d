...
void createMachine(CreateMachineArgs args, MachineType machineType, string machineName, User user) {
    auto infoJSON = execute(["ssh", args.sshPath, "sudo nix --experimental-features \\'nix-command flakes\\' --refresh --accept-flake-config run github:metacraft-labs/nixos-modules/#mcl-devops host-info"],false, false);
