{withSystem, ...}: {
  flake.nixosModules.ethereum-validators-monitoring = {
    ...
    cfg = config.services.ethereum-validators-monitoring;
      ...
      virtualisation.oci-containers = {
        ...
        containers = {
          ...
          clickhouse-server = {
            ...
            environment = {
              CLICKHOUSE_USER = cfg.args.db-user;
              CLICKHOUSE_PASSWORD = cfg.args.db-password;
              CLICKHOUSE_DB = cfg.args.db-name;
            };
            ports = ["8123:8123"];
