...
- [ ] Populate manual-matches.csv for peripherals (keyboards, mice, monitors need host assignment)
- [x] Track standalone items (46 entries: 6 switches, 3 UPS, 15 cables, 10 power strips, 9 pads, 3 bags, 1 rack)
- [x] Track ignored items (81 entries: 23 bundles, 25 services, 26 advances, 3 shipping, 4 credits)

## Files

| File | Purpose | Status |
|------|---------|--------|
| `inventory/manual-matches.csv` | Hand-matched entries | ✅ Populated (127 entries) |
| `inventory/unmatched-invoices.csv` | Raw unmatched export | ✅ Generated by --export-unmatched |
| `inventory/unmatched-invoices-categorized.csv` | Categorized for review | ✅ With section headers |
...
- **2026-01-24**: Populated manual-matches.csv with 127 entries (46 standalone + 81 ignored)
- **2026-01-24**: Generated unmatched-invoices-categorized.csv with section headers for review
